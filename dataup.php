...
if(isset($_POST['btn']) && $_POST['btn'] == 'Update' && isset($_POST['nama']) && isset($_POST['kwn']) && isset($_POST['ttl']) && isset($_POST['agama']) && isset($_POST['nid']) && isset($_POST['jalur']) && isset($_POST['tempat']) && isset($_POST['nim']) && isset($_POST['prodi']) && isset($_POST['jk']) && isset($_POST['angkatan'])  ){
    ...
    $update_user = mysqli_query($db_connection, "UPDATE `biodata` SET
        nama = '$nama',
        kwn = '$kwn',
        ttl = '$ttl',
        agama = '$agama',
